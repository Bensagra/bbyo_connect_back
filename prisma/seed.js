...
async function main() {
    await clearDatabase();
    const passwordHash = await argon2_1.default.hash("ChangeMe123!");
    ...
    const globalAdmin = await prisma.user.create({
        data: {
            ...
            memberId: "GADM-100",
            passwordHash,
            role: client_1.Role.global_admin,
            status: client_1.UserStatus.active,
        },
    });
    const [teenVerifiedA, teenVerifiedB, teenPending, guestUser] = await Promise.all([
        prisma.user.create({
            data: {
                ...
                memberId: "TEEN-100",
                passwordHash,
                role: client_1.Role.teen_verified,
                status: client_1.UserStatus.active,
            },
        }),
        prisma.user.create({
        ...
        prisma.user.create({
            data: {
                ...
                memberId: "TEEN-102",
                passwordHash,
                role: client_1.Role.teen_pending,
        ...
        data: [
            {
                ...
                languages: [client_1.Locale.en, client_1.Locale.he],
            ...
            },
            {
                ...
                languages: [client_1.Locale.es, client_1.Locale.en],
            ...
            },
            {
                ...
                languages: [client_1.Locale.he, client_1.Locale.en],
    ...
    const chapterUser = await prisma.user.create({
        data: {
            ...
            memberId: "CHAP-100",
            passwordHash,
            role: client_1.Role.chapter_verified,
            status: client_1.UserStatus.active,
        },
    });
    ...
    await prisma.user.update({
        ...
        data: { role: client_1.Role.teen_verified, status: client_1.UserStatus.active },
    });
    const chapterPendingUser = await prisma.user.create({
        data: {
            ...
            memberId: "CHAP-101",
            passwordHash,
            role: client_1.Role.chapter_pending,
            status: client_1.UserStatus.pending,
        },
    });
    await prisma.chapterProfile.create({
    ...
    await prisma.user.update({
        ...
        data: { role: client_1.Role.chapter_verified, status: client_1.UserStatus.active },
    });
    const post = await prisma.post.create({
        data: {
            authorUserId: teenVerifiedA.id,
            category: client_1.PostCategory.leadership,
            text: "Leadership summit recap in four languages!",
            language: client_1.Locale.en,
            visibility: client_1.Visibility.global,
            media: {
    ...
    const event = await prisma.event.create({
        data: {
            ...
            location: "Chicago HQ",
            isVirtual: true,
            visibility: client_1.EventVisibility.public,
        },
    });
    await prisma.eventRegistration.create({
        data: {
            eventId: event.id,
            userId: guestUser.id,
            status: client_1.EventRegistrationStatus.registered,
        },
    });
    ...
    await prisma.resource.createMany({
        data: [
            ...
            },
            {
                ...
                visibility: client_1.Visibility.region,
                createdBy: advisor.id,
            },
        ],
    });
    ...
    await prisma.pointsLedger.createMany({
        data: [
            {
                userId: teenVerifiedA.id,
                sourceType: client_1.PointsSourceType.post,
                sourceId: post.id,
                points: 40,
            },
            {
                userId: teenVerifiedA.id,
                sourceType: client_1.PointsSourceType.event_checkin,
                sourceId: event.id,
                points: 60,
            },
        ],
    ...
    const report = await prisma.report.create({
        data: {
            ...
            targetType: client_1.ReportTargetType.post,
            targetId: post.id,
    ...
    await prisma.moderationAction.create({
        data: {
            ...
            actionType: client_1.ModerationActionType.note,
    ...
    await prisma.notification.createMany({
        data: [
            {
                userId: teenVerifiedA.id,
                type: client_1.NotificationType.gamification,
                title: "Badge earned",
    ...
    await prisma.auditLog.createMany({
        data: [
            ...
            },
            {
                ...
                metadataJson: { reviewerRole: client_1.Role.advisor },
            },
        ],
    });
